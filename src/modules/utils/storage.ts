...
export const saveCreator = async (creator: CreatorProfile): Promise<void> => {
  ...
  const { error } = await supabase
    ...
    .upsert({
      ...
      address_house_no: creator.addressHouseNo ?? null,
      address_village: creator.addressVillage ?? null,
      address_soi: creator.addressSoi ?? null,
      address_road: creator.addressRoad ?? null,
      address_sub_district: creator.addressSubDistrict ?? null,
      address_district: creator.addressDistrict ?? null,
      address_province: creator.addressProvince ?? null,
      address_postal_code: creator.addressPostalCode ?? null,
      type: creator.type,
...
const mapDbToCreatorProfile = (row: any): CreatorProfile => {
  ...
  return {
    ...
    addressHouseNo: row.address_house_no || undefined,
    addressVillage: row.address_village || undefined,
    addressSoi: row.address_soi || undefined,
    addressRoad: row.address_road || undefined,
    addressSubDistrict: row.address_sub_district || undefined,
    addressDistrict: row.address_district || undefined,
