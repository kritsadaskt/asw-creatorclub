...
import aff_icon_mobile from '@/assets/aff-img-m.webp';
import fgf_icon_mobile from '@/assets/fgf-img-m.webp';
  ...
  return (
    <section id="creator_tools" className="relative bg-primary text-white pt-10 pb-10">
      <div className="container mx-auto px-6">
        ...
        <p className="text-center text-neutral-50 font-light text-base lg:text-xl">รับโอกาสในการเข้าถึงเครื่องมือสร้างรายได้<br className="block md:hidden" />จากคอนเทนต์</p>
        <div className="h-10"></div>
        <div className="flex flex-col md:flex-row justify-center gap-7 max-w-6xl mx-auto">
          <div className="aff bg-gradient-to-br min-h-[250px] from-white to-orange-100 w-full md:w-1/2 rounded-lg p-7 pb-0 xl:pb-7 shadow-lg relative overflow-hidden">
            <h4 className="text-3xl font-medium mb-2 text-primary">AFFILIATE PROGRAM</h4>
            <p className="text-black w-full lg:w-2/3">เลือกโปรโมท 36 โครงการจาก ASSETWISE ผ่าน<br className='hidden xl:block' />โซเชียลมีเดียเพื่อรับค่าคอมมิชชันง่าย ๆ
            เพียงแชร์ลิงก์หรือโพสต์คอนเทนต์ เมื่อมีการจองรับผลตอบแทนสูงสุดถึง 500,000 บาท*</p>
            <Image src={aff_icon} alt="AFFILIATE PROGRAM" width={500} height={500} className="hidden lg:block absolute -bottom-[30%] left-0 lg:-bottom-[30%] lg:-right-[13%] lg:left-auto w-full md:w-[250px] xl:w-[280px] h-auto xl:-scale-x-100" />
            ...
            <Image src={aff_icon_mobile} alt="AFFILIATE PROGRAM" width={500} height={500} className="block lg:hidden w-4/5 h-auto float-right" />
          </div>
          <div className="fgf bg-gradient-to-br min-h-[250px] from-white to-orange-100 w-full md:w-1/2 rounded-lg p-7 pb-0 shadow-lg relative overflow-hidden">
            ...
            <Image src={fgf_icon} alt="FRIEND GET FRIENDS" width={500} height={500} className="hidden lg:block absolute -bottom-[30%] left-0 lg:-bottom-[35%] lg:-right-[15%] lg:left-auto w-full md:w-[250px] xl:w-[320px] h-auto" />
            <div className="h-5"></div>
            ...
            <Image src={fgf_icon_mobile} alt="FRIEND GET FRIENDS" width={500} height={500} className="block lg:hidden w-[183px] h-auto float-right" />
          </div>
        </div>
      </div>
