      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-7 lg:gap-0">
          <div className='lg:pr-7 pr-0 flex flex-col justify-between gap-12'>
            ...
            <a href="#" className='text-2xl h-auto w-[220px] block mx-auto rounded-md bg-gradient-to-br from-orange-400 to-orange-600 px-7 py-4 leading-none text-center cursor-pointer'>สมัครเข้าร่วม</a>
          </div>
